...
"use strict";class DSRenderer{constructor(e){this.browser=e,this.util=e.util}renderShacl(){this.browser.elem.innerHTML='<pre style="font-size: medium; background: none; text-align: left; width: auto; padding: 0; overflow: visible; color: rgb(0, 0, 0); line-height: normal; display: block; font-family: monospace; margin: 1em 0; word-wrap: break-word; white-space: pre-wrap;">'+JSON.stringify(this.browser.ds,null,2)+"</pre>"}render(){this.dsNode=this.browser.dsNode,this.node=this.dsNode.node;var e=this.createHeader()+("Class"===this.dsNode.type?this.createClassPropertyTable():this.createEnumerationMembers());this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",e)}createHeader(){var e,t,r="";if(this.browser.path){var s=this.node["sh:class"];e=this.util.prettyPrintIri(s),t=this.browser.sdoAdapter.getTerm(s).getDescription(),r=this.createBreadcrumbs()}else{var i=this.browser.ds["@graph"][0];e=i["schema:name"],t=i["schema:description"]}return t=this.util.repairLinksInHTMLCode(t),this.createNavigation()+'<h1 property="schema:name">'+e+"</h1>"+this.util.createExternalLinkLegend()+r+'<div property="schema:description">'+t+"<br><br></div>"}createBreadcrumbs(){return'<h4><span class="breadcrumbs">'+this.util.createJSLink("path",null,this.browser.ds["@graph"][0]["schema:name"])+" > "+this.browser.path.split("-").map((e,t,r)=>{if(t%2==0)return e;var s=r.slice(0,t+1).join("-");return this.util.createJSLink("path",s,e)}).join(" > ")+"</span></h4>"}createNavigation(){return'<span style="float: right;">('+this.util.createJSLink("format","shacl","SHACL serialization")+(this.browser.list?" | from List: "+this.util.createJSLink("ds",null,this.browser.list["schema:name"]):"")+")</span>"}createClassPropertyTable(){var e=(this.browser.path?this.node["sh:node"]["sh:property"].slice(0):this.node["sh:property"].slice(0)).map(e=>this.createClassProperty(e)).join("");return this.util.createDefinitionTable(["Property","Expected Type","Description","Cardinality"],e)}createClassProperty(e){var t=this.browser.sdoAdapter.getProperty(e["sh:path"]),r=this.util.prettyPrintIri(t.getIRI(!0));return this.util.createTableRow("rdf:Property",t.getIRI(),"rdfs:label",this.util.createLink(t.getIRI(),r),this.createClassPropertySideCols(e,r),"prop-name")}createClassPropertySideCols(e,t){var r=this.createExpectedTypes(t,e["sh:or"]),s=this.createCardinality(e);return'<td class="prop-ect">'+r+'</td><td class="prop-desc">'+this.createClassPropertyDescText(e)+'</td><td class="prop-ect">'+s+"</td>"}createClassPropertyDescText(e){var t=this.util.prettyPrintIri(e["sh:path"]),r="";try{r=this.browser.sdoAdapter.getProperty(t).getDescription()}catch(e){}var s=e["rdfs:comment"]?e["rdfs:comment"]:"",i="";return""!==r&&(""!==s&&(i+="<b>From Vocabulary:</b> "),i+=r),""!==s&&(""!==r&&(i+="<br><b>From Domain Specification:</b> "),i+=s),this.util.repairLinksInHTMLCode(i)}createExpectedTypes(e,t){var r="";return t.forEach(t=>{var s;t["sh:datatype"]?s=t["sh:datatype"]:t["sh:class"]&&(s=t["sh:class"]);var i=this.util.dataTypeMapperFromSHACL(s);if(null!==i)r+=this.util.createLink(i);else{s=this.util.rangesToString(s);var a=e+"-"+s;r+=this.util.createJSLink("path",a,s,null,"-")}r+="<br>"}),r}createCardinality(e){var t,r=e["sh:minCount"],s=e["sh:maxCount"],i="";return r&&0!==r?s&&0!==s?r!==s?(t="This property is required. It must have between "+r+" and "+s+" value(s).",i=r+".."+s):(t="This property is required. It must have "+r+" value(s).",i=r):(t="This property is required. It must have at least "+r+" value(s).",i=r+"..N"):s&&0!==s?(t="This property is optional. It must have at most "+s+" value(s).",i="0.."+s):(t="This property is optional. It may have any amount of values.",i="0..N"),'<span title="'+t+'">'+i+"</span>"}createEnumerationMembers(){var e=this.browser.sdoAdapter.getTerm(this.node["sh:class"]).getEnumerationMembers();return 0!==e.length?'An Enumeration with:<br><b><a id="enumbers" title="Link: #enumbers" href="#enumbers" class="clickableAnchor">Enumeration members</a></b><ul>'+e.map(e=>{var t=this.browser.sdoAdapter.getEnumerationMember(e);return"<li>"+this.util.createLink(t.getIRI(),e)+"</li>"}).join("")+"</ul><br>":""}}module.exports=DSRenderer;

},{}],87:[function(require,module,exports){
"use strict";class ListRenderer{constructor(e){this.browser=e,this.util=e.util}render(){var e=this.createHeader()+this.createDSTable();this.browser.elem.innerHTML=this.util.createMainContent("schema:DataSet",e)}createHeader(){return"<h1>"+this.browser.list["schema:name"]+"</h1>"+this.util.createExternalLinkLegend()+this.browser.list["schema:description"]||""}createDSTable(){return this.util.createDefinitionTable(["Name","IRI","Description"],this.createDSTbody(),{class:"supertype"})}createDSTbody(){return this.browser.list["schema:hasPart"].map(e=>this.util.createTableRow("http://vocab.sti2.at/ds/Domain Specification",e["@id"],"schema:name",this.util.createJSLink("ds",e["@id"].split("/").pop(),e["schema:name"]||"No Name"),this.createDSSideCols(e))).join("")}createDSSideCols(e){return'<td property="@id">'+this.util.createLink(e["@id"])+'</td><td property="schema:description">'+(e["schema:description"]||"")+"</td>"}}module.exports=ListRenderer;

},{}],88:[function(require,module,exports){
"use strict";function asyncGeneratorStep(t,e,r,n,a,s,i){try{var o=t[s](i),l=o.value}catch(t){return void r(t)}o.done?e(l):Promise.resolve(l).then(n,a)}function _asyncToGenerator(t){return function(){var e=this,r=arguments;return new Promise(function(n,a){var s=t.apply(e,r);function i(t){asyncGeneratorStep(s,n,a,i,o,"next",t)}function o(t){asyncGeneratorStep(s,n,a,i,o,"throw",t)}i(void 0)})}}class Util{constructor(t){this.browser=t}parseToObject(t){var e=this;return _asyncToGenerator(function*(){var r;return e.isString(t)?(r=e.isValidUrl(t)?yield e.getJson(t):t,JSON.parse(r)):t})()}isString(t){return"string"==typeof t||t instanceof String}isValidUrl(t){try{new URL(t)}catch(t){return!1}return!0}getJson(t){return new Promise(function(e,r){var n=new XMLHttpRequest;n.open("GET",t),n.setRequestHeader("Accept","application/json"),n.onload=function(){this.status>=200&&this.status<300?e(n.response):r({status:this.status,statusText:n.statusText})},n.onerror=function(){r({status:this.status,statusText:n.statusText})},n.send()})}prettyPrintIri(t){return t.replace(/^(schema:|https?:\/\/schema.org\/)(.+)/,"$2")}repairLinksInHTMLCode(t){return t.replace(/<a(.*?)href="(.*?)"/g,(t,e,r)=>{return r.startsWith("/")&&(r="http://schema.org"+r),"<a"+e+'href="'+r+'" style="'+this.createExternalLinkStyle(r)+'" target="_blank"'})}dataTypeMapperFromSHACL(t){switch(t){case"xsd:string":return"http://schema.org/Text";case"xsd:boolean":return"http://schema.org/Boolean";case"xsd:date":return"http://schema.org/Date";case"xsd:dateTime":return"http://schema.org/DateTime";case"xsd:time":return"http://schema.org/Time";case"xsd:double":return"http://schema.org/Number";case"xsd:float":return"http://schema.org/Float";case"xsd:integer":return"http://schema.org/Integer";case"xsd:anyURI":return"http://schema.org/URL"}return null}rangesToString(t){return Array.isArray(t)?t.map(t=>this.prettyPrintIri(t)).join(" + "):this.prettyPrintIri(t)}createIriWithQueryParam(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=new URLSearchParams(window.location.search);if(e&&""!==e){var a=n.get(t);null!==a&&r?n.set(t,a+r+e):n.set(t,e)}else n.delete(t);var s=n.toString();return window.location.protocol+"//"+(window.location.host?window.location.host:"")+window.location.pathname+(""!==s?"?"+s:"")}createJSLink(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null,s=this.createIriWithQueryParam(t,e,a);return'<a class="a-js-link" href="'+this.escHtml(s)+'" onclick="return false;"'+this.createHtmlAttr(n)+">"+(r?this.escHtml(r):this.escHtml(e))+"</a>"}escHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}createHtmlAttr(t){return t?Object.entries(t).map(t=>" "+this.escHtml(t[0])+'="'+this.escHtml(t[1])+'"').join(""):""}createLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=new URL(t);if(window.location.hostname!==n.hostname){var a=" "+this.createExternalLinkStyle(t);r?r.hasOwnProperty("style")?r.style=r.style+a:r.style=a:r={style:a}}return'<a href="'+this.escHtml(t)+'" target="_blank"'+this.createHtmlAttr(r)+">"+(e?this.prettyPrintIri(e):this.prettyPrintIri(t))+"</a>"}createExternalLinkStyle(t){var e="background-position: center right; background-repeat: no-repeat; background-size: 10px 10px; padding-right: 13px; ";return/^https?:\/\/schema.org/.test(t)?e+="background-image: url(https://raw.githubusercontent.com/YarnSeemannsgarn/ds-browser/main/images/external-link-icon-red.png);":e+="background-image: url(https://raw.githubusercontent.com/YarnSeemannsgarn/ds-browser/main/images/external-link-icon-blue.png);",e}createTableRow(t,e,r,n,a){var s=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null;return'<tr typeof="'+t+'" resource="'+e+'">'+this.createMainCol(r,n,s)+a+"</tr>"}createMainCol(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return"<th"+(r?' class="'+r+'"':"")+' scope="row">'+this.createCodeLink(e,{property:t})+"</th>"}createCodeLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;return"<code"+this.createHtmlAttr(e)+">"+this.createFullLink(t,r,n)+"</code>"}createFullLink(t,e,r){var n=null;try{n=this.browser.sdoAdapter.getTerm(t)}catch(t){}return""+(r?this.createSemanticLink(r,t):"")+(n?this.createLink(t,e):t)}createSemanticLink(t,e){return'<link property="'+this.escHtml(t)+'" href="'+this.escHtml(this.createHref(e))+'">'}createHref(t){return this.browser.sdoAdapter.getTerm(t).getIRI()}createDefinitionTable(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return Array.isArray(t)||(t=[t]),Array.isArray(e)||(e=[e]),'<table class="definition-table"><thead><tr>'+t.map(t=>"<th>"+t+"</th>").join("")+"</tr></thead><tbody"+this.createHtmlAttr(r)+">"+(e[0].startsWith("<tr")?e.join(""):e.map(t=>"<tr>"+t+"</tr>").join(""))+"</tbody></table>"}createMainContent(t,e){return'<div id="mainContent" vocab="http://schema.org/" typeof="'+t+'" resource="'+window.location+'">'+e+"</div>"}createExternalLinkLegend(){return'<p style="font-size: 12px; margin-top: 0">(<span style="'+("margin-right: 3px; "+this.createExternalLinkStyle(""))+'"></span>External link<span style="'+("margin-right: 3px; "+this.createExternalLinkStyle("http://schema.org")+" margin-left: 6px;")+'"></span>External link to schema.org )</p>'}}module.exports=Util;
