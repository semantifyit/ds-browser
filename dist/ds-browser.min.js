...
},{"./adapters/http":2,"./adapters/xhr":2,"./core/enhanceError":12,"./helpers/normalizeHeaderName":24,"./utils":28,"_process":56}],17:[function(require,module,exports){
...
!function(e,r){"object"==typeof exports&&"undefined"!=typeof module?module.exports=r():"function"==typeof define&&define.amd?define(r):e.jsonFormatHighlight=r()}(this,function(){"use strict";var e={keyColor:"dimgray",numberColor:"lightskyblue",stringColor:"lightcoral",trueColor:"lightseagreen",falseColor:"#f66578",nullColor:"cornflowerblue"},r={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","`":"&#x60;","=":"&#x3D;"};return function(t,o){void 0===o&&(o={});var l=typeof t;"string"!==l&&(t=JSON.stringify(t,null,2)||l);var n=Object.assign({},e,o);return(t=t.replace(/&/g,"&").replace(/</g,"<").replace(/>/g,">")).replace(/("(\\u[a-zA-Z0-9]{4}|\\[^u]|[^\\"])*"(\s*:)?|\b(true|false|null)\b|-?\d+(?:\.\d*)?(?:[eE][+]?\d+)?)/g,function(e){var t,o=n.numberColor,l="";return/^"/.test(e)?/:$/.test(e)?o=n.keyColor:(o=n.stringColor,e='"'+(t=e.substr(1,e.length-2),String(t).replace(/[&<>"'`=]/g,function(e){return r[e]}))+'"',l="word-wrap:break-word;white-space:pre-wrap;"):o=/true/.test(e)?n.trueColor:/false/.test(e)?n.falseColor:/null/.test(e)?n.nullColor:o,'<span style="'+l+"color:"+o+'">'+e+"</span>"})}});
...
},{"./constants":40,"./context":41,"./graphTypes":47,"./nodeMap":49,"./types":52,"./url":53,"./util":54,"canonicalize":31}],52:[function(require,module,exports){
...
},{"yallist":80}],56:[function(require,module,exports){
...
},{"setimmediate":77}],60:[function(require,module,exports){
...
},{"./IdentifierIssuer":58,"./MessageDigest":59,"./NQuads":60,"./Permuter":61,"timers":78}],63:[function(require,module,exports){
...
},{"_process":56}],78:[function(require,module,exports){
...
},{"process/browser.js":56,"timers":78}],79:[function(require,module,exports){
...
},{"./iterator.js":79}],81:[function(require,module,exports){
const SDOAdapter=require("schema-org-adapter"),DSBrowserIFrameContent=require("./templates/DSBrowserIFrameContent.js"),Util=require("./Util"),DSHandler=require("./DSHandler"),ListRenderer=require("./ListRenderer"),DSRenderer=require("./DSRenderer"),NativeRenderer=require("./NativeRenderer"),TreeRenderer=require("./TreeRenderer"),SHACLRenderer=require("./SHACLRenderer"),NavigationBar=require("./NavigationBarRenderer.js");class DSBrowser{constructor(t){this.dsCache={},this.sdoCache=[],this.util=new Util(this),this.navigationBar=new NavigationBar(this),this.dsHandler=new DSHandler(this),this.listRenderer=new ListRenderer(this),this.dsRenderer=new DSRenderer(this),this.nativeRenderer=new NativeRenderer(this),this.treeRenderer=new TreeRenderer(this),this.shaclRenderer=new SHACLRenderer(this),this.editFunction=t.editFunction,this.targetElement=t.targetElement,this.locationControl=!1!==t.locationControl,this.selfFileHost=!0===t.selfFileHost,this.locationControl?this.readStateFromUrl():(this.listId=t.listId||null,this.dsId=t.dsId||null,this.path=t.path||null,this.viewMode=t.viewMode||null,this.format=t.format||null),this.locationControl&&window.addEventListener("popstate",async()=>{this.readStateFromUrl(),await this.render()}),this.initIFrame()}async initIFrame(){this.targetElement.innerHTML=this.frame(),this.dsbFrame=document.getElementById("ds-browser-iframe"),this.dsbContext=this.dsbFrame.contentWindow.document,this.dsbContext.open(),this.dsbContext.write(DSBrowserIFrameContent),this.dsbContext.close(),setTimeout(function(){this.dsbContainer=this.dsbContext.getElementById("ds-browser-main-container"),this.render()}.bind(this),250)}frame(){return'<div><iframe id="ds-browser-iframe" width="100%" height="100%" frameborder="0" scrolling="no"></iframe></div>'}fixFrameSize(){const t=this.dsbContext.body;this.dsbFrame.style.height=t.scrollHeight+"px",console.log("size adaption")}async render(){if(this.dsbContainer.innerHTML=this.util.createHtmlLoading(),this.fixFrameSize(),await this.renderInit(),"shacl"===this.format)this.shaclRenderer.render();else if(this.dsId&&"tree"!==this.viewMode&&"table"!==this.viewMode)this.nativeRenderer.render();else if(this.dsId&&"tree"===this.viewMode)this.treeRenderer.render(),this.fixFrameSize();else{if(!this.listId)throw new Error("Input parameters invalid.");this.listRenderer.render(),this.fixFrameSize()}this.addJSLinkEventListener(),document.body.scrollTop=document.documentElement.scrollTop=0}async renderInit(){!this.listId||this.list&&this.list["@id"].endsWith(this.listId)||await this.initList(),!this.dsId||this.ds&&this.util.getDSRootNode(this.ds)["@id"].endsWith(this.dsId)||await this.initDS(),this.ds&&(this.dsRootNode=this.util.getDSRootNode(this.ds),this.dsNode=this.dsHandler.getDSNodeForPath())}async initList(){this.list=await this.util.parseToObject(this.util.getFileHost()+"/list/"+this.listId+"?representation=lean")}async initDS(){if(this.dsCache[this.dsId])this.ds=this.dsCache[this.dsId];else{let t=await this.util.parseToObject(this.util.getFileHost()+"/ds/"+this.dsId+"?populate=true");t&&t["@graph"]&&t["@graph"][0]&&!t["@graph"][0]["ds:version"]&&(t=await this.util.parseToObject(this.util.getFileHost()+"/api/v2/domainspecifications/dsv7/"+this.dsId+"?populate=true")),this.dsCache[this.dsId]=t,this.ds=t}this.sdoAdapter||(this.sdoAdapter=new SDOAdapter({schemaHttps:!0}));const t=await this.getVocabUrlsForDS();let e=this.util.getSdoAdapterFromCache(t);e||(e=new SDOAdapter({schemaHttps:!0,equateVocabularyProtocols:!0}),await e.addVocabularies(t),this.sdoCache.push({vocabUrls:t,sdoAdapter:e})),this.sdoAdapter=e}async getVocabUrlsForDS(){if(!this.ds)return[];let t=[];const e=this.util.getDSRootNode(this.ds);if(e&&Array.isArray(e["ds:usedVocabulary"])&&(t=this.util.hardCopyJson(e["ds:usedVocabulary"])),e&&e["schema:schemaVersion"]){const s=this.getSDOVersion(e["schema:schemaVersion"]);t.push(await this.sdoAdapter.constructSDOVocabularyURL(s))}return t}getSDOVersion(t){if(t.startsWith("http")){let e=/.*schema\.org\/version\/([0-9.]+)\//g.exec(t);if(e&&e[1])return e[1]}return t}addJSLinkEventListener(){const t=this.targetElement.getElementsByClassName("a-js-link");for(const e of t)e.addEventListener("click",async t=>{this.locationControl?t.ctrlKey?window.open(e.href):(history.pushState(null,null,e.href),this.navigate(JSON.parse(decodeURIComponent(e.getAttribute("data-state-changes"))))):this.navigate(JSON.parse(decodeURIComponent(e.getAttribute("data-state-changes"))))})}readStateFromUrl(){const t=new URLSearchParams(window.location.search);if(this.path=t.get("path")||null,this.path&&this.path.includes("   ")&&(this.path=this.path.replace(new RegExp(" {3}","g")," + ")),this.format=t.get("format")||null,this.viewMode=t.get("mode")||null,window.location.pathname.includes("/ds/")){this.listId=null;let t=window.location.pathname.substring("/ds/".length);this.dsId!==t&&(this.dsId=t,this.ds=null)}else if(window.location.pathname.includes("/list/")){let e=window.location.pathname.substring("/list/".length);this.listId!==e&&(this.listId=e,this.list=null);let s=t.get("ds")||null;this.dsId!==s&&(this.dsId=s,this.ds=null)}else this.listId=null,this.list=null,this.dsId=null,this.ds=null}navigate(t){void 0!==t.listId&&(this.listId=t.listId),void 0!==t.dsId&&(this.dsId=t.dsId),void 0!==t.path&&(this.path=t.path),void 0!==t.viewMode&&(this.viewMode=t.viewMode),void 0!==t.format&&(this.format=t.format),null===this.listId&&(this.list=void 0),null===this.dsId&&(this.ds=void 0),this.ds||(this.path=null),this.render()}}module.exports=DSBrowser;

},{"./DSHandler":82,"./DSRenderer":83,"./ListRenderer":84,"./NativeRenderer":85,"./NavigationBarRenderer.js":86,"./SHACLRenderer":87,"./TreeRenderer":88,"./Util":89,"./templates/DSBrowserIFrameContent.js":91,"schema-org-adapter":74}],82:[function(require,module,exports){
class DSHandler{constructor(t){this.browser=t,this.util=t.util}getDSNodeForPath(){let t=this.browser.dsRootNode,e={type:"",node:{}};if(t)if(this.browser.path){let s=this.browser.path.split("-");for(let e=0;e<s.length;e++){if(""===s[e])continue;let r;(r=s[e].indexOf(":")>=0?s[e].substring(s[e].indexOf(":")+1):s[e]).charAt(0).toUpperCase()===r.charAt(0)?t&&(t=this.getClass(t["sh:or"],s[e])):t&&e!==s.length-1&&(t=this.getProperty(t["sh:property"],s[e]))}try{this.browser.sdoAdapter.getTerm(t["sh:class"][0]),"schema:Enumeration"===this.browser.sdoAdapter.getTerm(t["sh:class"][0]).getTermType()?e.type="Enumeration":e.type="Class"}catch(t){e.type="error"}}else e.type="Class";else e.type="error";return e.node=t,e}getClass(t,e){for(const s of t){if(!s["sh:node"])continue;let t=this.util.getClassNodeIfExists(s);if(t["sh:class"]&&this.rangesToString(t["sh:class"])===e)return t}return null}getProperty(t,e){return t.find(t=>this.rangesToString(t["sh:path"])===e)}dataTypeMapperFromSHACL(t){switch(t){case"xsd:string":case"rdf:langString":return"https://schema.org/Text";case"xsd:boolean":return"https://schema.org/Boolean";case"xsd:date":return"https://schema.org/Date";case"xsd:dateTime":return"https://schema.org/DateTime";case"xsd:time":return"https://schema.org/Time";case"xsd:double":return"https://schema.org/Number";case"xsd:float":return"https://schema.org/Float";case"xsd:integer":return"https://schema.org/Integer";case"xsd:anyURI":return"https://schema.org/URL"}return null}rangesToString(t){return Array.isArray(t)?t.map(t=>this.util.prettyPrintIri(t)).join(" + "):this.util.prettyPrintIri(t)}createHtmlCardinality(t,e){let s,r="";return t&&0!==t?e&&0!==e?t!==e?(s="This property is required. It must have between "+t+" and "+e+" value(s).",r=t+".."+e):(s="This property is required. It must have "+t+" value(s).",r=t):(s="This property is required. It must have at least "+t+" value(s).",r=t+"..N"):e&&0!==e?(s="This property is optional. It must have at most "+e+" value(s).",r="0.."+e):(s="This property is optional. It may have any amount of values.",r="0..N"),`<span title="${s}">${r}</span>`}generateDsClass(t,e,s,r=0){let i={};const n=t["sh:targetClass"]||t["sh:class"];let a;i.text=n?this.util.prettyPrintClassDefinition(n):"",i.icon="glyphicon glyphicon-list-alt",e||(i.state={opened:!0});try{a=-1===i.text.indexOf(",")?this.util.repairLinksInHTMLCode(this.browser.sdoAdapter.getClass(i.text).getDescription()):"No description found."}catch(t){a="No description found."}return i.data={},i.data.dsDescription=a,i.children=this.processChildren(t,s,r+1),i}processChildren(t,e,s){const r=[];let i=t["sh:property"];return i&&i.forEach(t=>{const i=this.generateDsProperty(t,e,s);i&&r.push(i)}),r}generateDsProperty(t,e,s){const r={};return r.justification=this.util.getLanguageString(t["rdfs:comment"]),r.text=this.util.prettyPrintIri(t["sh:path"]),r.data={},r.data.minCount=t["sh:minCount"],r.data.maxCount=t["sh:maxCount"],r.children=[],this.processEnum(r,t["sh:or"][0]),this.processVisibility(r,t["sh:minCount"]),this.processRanges(r,t["sh:or"],e,s),e?r:r.data.isOptional?null:r}processEnum(t,e){let s;t.isEnum=!1;try{const r=e["sh:class"];s=this.browser.sdoAdapter.getEnumeration(r),t.isEnum=!0}catch(t){}if(t.isEnum){const r=this.getEnumMemberArray(e["sh:in"],s);r.forEach(t=>{const e=this.browser.sdoAdapter.getEnumerationMember(t.name);t.description=this.util.repairLinksInHTMLCode(e.getDescription())}),t.data.enuMembers=r,t.children=r.map(t=>({children:[],data:{dsRange:"",dsDescription:this.util.repairLinksInHTMLCode(t.description)},icon:"glyphicon glyphicon-chevron-right",text:t.name}))}}getEnumMemberArray(t,e){if(t)return t.map(t=>{let e=t["@id"];return{name:e=e.replace("schema:","")}});return e.getEnumerationMembers().map(t=>({name:t}))}processVisibility(t,e){t.icon="glyphicon glyphicon-tag",!e>0?(t.icon+=" optional-property",t.data.isOptional=!0):(t.icon+=" mandatory-property",t.data.isOptional=!1)}processRanges(t,e,s,r){let i=!1;if(e){const n=this.generateDsRange(e);t.data.dsRange=n.rangeAsString;try{const e=this.browser.sdoAdapter.getProperty(t.text).getDescription();t.data.dsDescription=this.util.repairLinksInHTMLCode(e)}catch(e){t.data.dsDescription="No description found."}e.forEach(e=>{const n=this.util.getClassNodeIfExists(e);n&&n["sh:class"]&&(i=!0,r<8&&t.children.push(this.generateDsClass(n,!0,s,r)))})}i&&(t.state={opened:!0})}generateDsRange(t){let e={rangeAsString:""};return e.rangeAsString=t.map(t=>{let e,s;const r=t["sh:datatype"],i=this.util.getClassNodeIfExists(t),n=i&&i["sh:class"]?i["sh:class"]:null;return s=r?e=this.util.prettyPrintIri(this.dataTypeMapperFromSHACL(r)):i&&i["sh:property"]?"<strong>"+(e=this.util.prettyPrintClassDefinition(n))+"</strong>":e=this.util.prettyPrintClassDefinition(n)}).join(" or "),e}}module.exports=DSHandler;

},{}],83:[function(require,module,exports){
class DSRenderer{constructor(e){this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler,this.MODES={native:"native",tree:"tree"}}createViewModeSelectors(e=this.MODES.native){return'<div class="ds-selector-tabs ds-selector"><div class="selectors">'+(e===this.MODES.native?'<a class="selected">Native View</a>':this.util.createInternalLink({viewMode:null},"Native View"))+(e===this.MODES.tree?'<a class="selected">Tree View</a>':this.util.createInternalLink({viewMode:"tree"},"Tree View"))+"</div></div>"}createHtmlHeader(){this.dsNode=this.browser.dsNode,this.node=this.dsNode.node;let e,t,i="";if(this.browser.path){const s=this.node["sh:class"];e=this.dsHandler.rangesToString(s),t=this.createNodeDescription(s),i=this.createBreadcrumbs()}else{const i=this.browser.ds["@graph"][0];e=this.util.getLanguageString(i["schema:name"])||"Domain Specification",t=this.util.getLanguageString(i["schema:description"])||""}return t=this.util.repairLinksInHTMLCode(t),this.createNavigation()+'<h1 property="schema:name">'+e+"</h1>"+this.util.createHtmlExternalLinkLegend()+i+'<div property="schema:description">'+t+"<br><br></div>"}createNodeDescription(e){return e?1===e.length?this.browser.sdoAdapter.getTerm(e[0]).getDescription():e.map(e=>"<b>"+this.util.prettyPrintIri(e)+":</b> "+this.browser.sdoAdapter.getTerm(e).getDescription()).join("<br>"):""}createBreadcrumbs(){return`<h4><span class="breadcrumbs">\n            ${this.util.createInternalLink({path:null},this.util.getLanguageString(this.browser.dsRootNode["schema:name"])||"Domain Specification")} > ${this.browser.path.split("-").map((e,t,i)=>{if(t%2==0)return e;{const s=i.slice(0,t+1).join("-");return this.util.createInternalLink({path:s},e)}}).join(" > ")}\n            </span></h4>`}createNavigation(){let e;const t=this.browser.dsId;return`<span style="float: right;">(${e=this.browser.locationControl?this.util.createInternalLink({format:"shacl"},"SHACL serialization"):`<a href="https://semantify.it/ds/${t}?format=shacl" target="_blank">SHACL serialization</a>`}${this.browser.list?" | from List: "+this.util.createInternalLink({dsId:null,path:null},this.browser.list["schema:name"]):""})</span>`}createVisBtnRow(){return'<div id="btn-row" style="padding: 12px 0px 12px 5px; font-size: 14px; line-height: 1.42857143; color: #333;">Show: \n            <span id="btn-opt" class="btn-vis btn-vis-shadow" style="margin-left: 10px; padding: 5px;">\n                <img src="" class="glyphicon glyphicon-tag optional-property"> optional\n            </span>\n            <span id="btn-man" class="btn-vis" style="margin-left: 10px; padding: 5px;">\n                <img src="" class="glyphicon glyphicon-tag mandatory-property"> mandatory\n            </span></div>'}}module.exports=DSRenderer;

},{}],84:[function(require,module,exports){
class ListRenderer{constructor(t){this.browser=t,this.util=t.util}render(){const t=this.createHtmlHeader()+this.createHtmlDsTable();this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("schema:DataSet",t)}createHtmlHeader(){return`<h1>${this.browser.list["schema:name"]||""}</h1>\n            ${this.util.createHtmlExternalLinkLegend()}\n            ${this.browser.list["schema:description"]||""}`}createHtmlDsTable(){return this.util.createHtmlDefinitionTable(["Name","IRI","Description"],this.createHtmlDsTbody(),null,{class:"supertype"})}createHtmlDsTbody(){return this.browser.list["schema:hasPart"].map(t=>this.util.createHtmlTableRow("http://vocab.sti2.at/ds/Domain Specification",t["@id"],"schema:name",this.util.createInternalLink({dsId:t["@id"].split("/").pop()},t["schema:name"]||"No Name"),this.createHtmlDsSideCols(t))).join("")}createHtmlDsSideCols(t){return`<td property="@id">${this.util.createLink(t["@id"])}</td>\n            <td property="schema:description">${t["schema:description"]||""}</td>`}}module.exports=ListRenderer;

},{}],85:[function(require,module,exports){
const NativeFrame=require("./templates/NativeFrame.js");class NativeRenderer{constructor(t){this.browser=t,this.util=t.util,this.navigationBar=t.navigationBar,this.dsHandler=t.dsHandler,this.dsRenderer=t.dsRenderer}render(){this.dsNode=this.browser.dsNode,this.node=this.dsNode.node,this.browser.dsbContainer.innerHTML=this.util.createHtmlMainContent("rdfs:Class",this.navigationBar.frame()+NativeFrame),this.browser.dsbContext.getElementById("title-ds-name").textContent="this.dsNode name todo",this.navigationBar.render(),this.browser.fixFrameSize()}createHTMLEnumerationMembersTable(){const t=this.node["sh:in"].slice(0).map(t=>this.createHTMLEnumerationMemberRow(t)).join("");return this.util.createHtmlDefinitionTable(["Enumeration Member","Description"],t,{style:"margin-top: 0px; border-top: none;"})}createHTMLEnumerationMemberRow(t){const e=this.browser.sdoAdapter.getEnumerationMember(t["@id"]);return this.util.createHtmlTableRow("rdfs:Class",e.getIRI(),"rdfs:label",this.util.createTermLink(t["@id"]),this.createHTMLEnumerationMemberDescription(e))}createHTMLEnumerationMemberDescription(t){return`<td className="prop-desc">${this.util.repairLinksInHTMLCode(t.getDescription())}</td>`}createHtmlPropertiesTable(){let t;const e=(t=this.node["sh:property"].slice(0)).map(t=>this.createClassProperty(t)).join("");return this.util.createHtmlDefinitionTable(["Property","Expected Type","Description","Cardinality"],e,{style:"margin-top: 0px; border-top: none;"})}createClassProperty(t){const e=t["sh:path"],r=this.browser.sdoAdapter.getProperty(e);return this.util.createHtmlTableRow("rdf:Property",r.getIRI(),"rdfs:label",this.util.createTermLink(e),this.createClassPropertySideCols(t),"prop-name")}createClassPropertySideCols(t){return`<td class="prop-ect">${this.createHtmlExpectedTypes(t)}</td>\n            <td class="prop-desc">${this.createHtmlPropertyDescription(t)}</td>\n            <td class="prop-ect" style="text-align: center">${this.dsHandler.createHtmlCardinality(t["sh:minCount"],t["sh:maxCount"])}</td>`}createHtmlPropertyDescription(t){const e=this.util.prettyPrintIri(t["sh:path"]);let r;try{r=this.browser.sdoAdapter.getProperty(e).getDescription()}catch(t){r=""}const s=t["rdfs:comment"]?this.util.getLanguageString(t["rdfs:comment"]):"";let i="";return""!==r&&(""!==s&&(i+="<b>From Vocabulary:</b> "),i+=r),""!==s&&(""!==r&&(i+="<br><b>From Domain Specification:</b> "),i+=s),this.util.repairLinksInHTMLCode(i)}createHtmlExpectedTypes(t){const e=this.browser.sdoAdapter.getProperty(t["sh:path"]),r=this.util.prettyPrintIri(e.getIRI(!0));return t["sh:or"].map(t=>{let e,s=this.util.getClassNodeIfExists(t);t["sh:datatype"]?e=t["sh:datatype"]:s&&s["sh:class"]&&(e=s["sh:class"]);const i=this.dsHandler.dataTypeMapperFromSHACL(e);if(null!==i)return this.util.createLink(i);if(e=this.dsHandler.rangesToString(e),s&&Array.isArray(s["sh:property"])&&0!==s["sh:property"].length){const t=this.browser.path?this.browser.path+"-"+r+"-"+e:r+"-"+e;return this.util.createInternalLink({path:t},e)}if(s&&s["sh:class"]&&Array.isArray(s["sh:in"])){const t=this.browser.path?this.browser.path+"-"+r+"-"+e:r+"-"+e;return this.util.createInternalLink({path:t},e)}return this.util.createTermLink(e)}).join("<br>")}}module.exports=NativeRenderer;

},{"./templates/NativeFrame.js":93}],86:[function(require,module,exports){
const navBarTemplate=require("./templates/NavigationBar.js");class NavigationBarRenderer{constructor(e){this.browser=e,this.util=e.util}frame(){return'<div id="navbar-container"></div>'}render(){const e=this.browser.dsbContext.getElementById("navbar-container");let t,r,i,a;this.browser.editFunction?(t="",r="javascript:"+this.browser.editFunction):(t="d-none",r=""),this.browser.listId?(i="",a="javascript:"+this.browser.editFunction):(i="d-none",a="");let n=navBarTemplate;n=(n=(n=(n=n.replace(/{{editDsClass}}/g,t)).replace(/{{editDsHref}}/g,r)).replace(/{{listBtnClass}}/g,i)).replace(/{{listBtnHref}}/g,a),e.innerHTML=n}}module.exports=NavigationBarRenderer;

},{"./templates/NavigationBar.js":94}],87:[function(require,module,exports){
const formatHighlight=require("json-format-highlight");class SHACLRenderer{constructor(r){this.browser=r}render(){this.browser.targetElement.innerHTML='<pre style="font-size: large;\n            text-align: left;\n            width: auto;\n            padding: 10px 20px;\n            margin: 20px; \n            overflow: visible;\n            line-height: normal;\n            display: block;\n            font-family: monospace;\n            word-wrap: break-word;\n            white-space: pre-wrap;'+`">${formatHighlight(this.browser.ds,{keyColor:"black",numberColor:"#3A01DC",stringColor:"#DF0002",trueColor:"#C801A4",falseColor:"#C801A4",nullColor:"cornflowerblue"})}</pre>`}}module.exports=SHACLRenderer;

},{"json-format-highlight":32}],88:[function(require,module,exports){
class TreeRenderer{constructor(e){this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler,this.dsRenderer=e.dsRenderer}render(){const e=`${this.dsRenderer.createHtmlHeader()}\n            ${this.dsRenderer.createViewModeSelectors(this.dsRenderer.MODES.tree)}\n            <div id="div-iframe">\n            <iframe id="iframe-jsTree" frameborder="0" width="100%" scrolling="no"></iframe>\n            </div>`;this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdfs:Class",e),this.initIFrameForJSTree()}initIFrameForJSTree(){this.iFrame=document.getElementById("iframe-jsTree"),this.iFrameCW=this.iFrame.contentWindow;const e=this.iFrameCW.document,r=this.createJSTreeHTML();e.open(),e.write(r),e.close();const t=this.dsHandler.generateDsClass(this.browser.dsRootNode,!1,!1);this.mapNodeForJSTree([t])}createJSTreeHTML(){const e=this.dsRenderer.createVisBtnRow();return`<head>\n            <script src="https://code.jquery.com/jquery-3.5.1.min.js" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"><\/script>\n            <script src="https://cdnjs.cloudflare.com/ajax/libs/jstree/3.3.10/jstree.min.js"><\/script>\n            <script src="https://cdnjs.cloudflare.com/ajax/libs/jstreegrid/3.10.2/jstreegrid.min.js"><\/script>\n            <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css" />\n            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jstree/3.3.10/themes/default/style.min.css" />\n            ${this.createTreeStyle()}\n            </head>\n            <body>${e}<div id="jsTree"></div></body>`}createTreeStyle(){return"<style>\n            .optional-property { color: #ffa517; }\n            .mandatory-property { color: #00ce0c; }\n            .btn-vis-shadow {\n                cursor: pointer;\n                webkit-box-shadow: 0 4px 5px 0 rgba(0, 0, 0, 0.14), 0 1px 10px 0 rgba(0, 0, 0, 0.12), 0 2px 4px -1px rgba(0, 0, 0, 0.2);\n                box-shadow: 0 4px 5px 0 rgba(0, 0, 0, 0.14), 0 1px 10px 0 rgba(0, 0, 0, 0.12), 0 2px 4px -1px rgba(0, 0, 0, 0.2);\n            }\n            </style>"}mapNodeForJSTree(e){const r=this;this.iFrame.addEventListener("load",function(){r.iFrameCW.$("#jsTree").jstree({plugins:["grid"],core:{themes:{icons:!0,dots:!0,responsive:!0,stripes:!0,rootVisible:!1},data:e},grid:{columns:[{width:"20%",header:"Class / Property"},{header:"Range / Type",width:"20%",value:function(e){return e.data.dsRange}},{width:"17%",header:"Cardinality",value:function(e){if(e.data.dsRange)return'<p style="width: 100%; margin: 0; text-align: center; padding-right: 7px;">'+r.dsHandler.createHtmlCardinality(e.data.minCount,e.data.maxCount)+"</p>"}},{width:"50%",header:"Description",value:function(e){return'<p style="width: 100%; overflow: hidden; margin: 0; text-overflow: ellipsis;">'+e.data.dsDescription.replaceAll("</br>"," ")+"</p>"}}]}}).bind("ready.jstree after_open.jstree after_close.jstree refresh.jstree",r.adaptIframe.bind(r)),r.addIframeClickEvent()})}adaptIframe(){const e=window.scrollY,r=window.scrollX;this.iFrame.height="0px",this.iFrame.height=this.iFrameCW.document.body.scrollHeight,window.scrollTo(r,e)}addIframeClickEvent(){this.iFrameCW.$(".btn-vis-shadow").click(e=>{const r=this.iFrameCW.$(e.currentTarget);let t,s;r.removeClass("btn-vis-shadow"),"btn-opt"===r.attr("id")?(t=this.iFrameCW.$("#btn-man"),s=!0):(t=this.iFrameCW.$("#btn-opt"),s=!1),t.addClass("btn-vis-shadow"),r.off("click"),this.addIframeClickEvent();const i=this.dsHandler.generateDsClass(this.browser.dsRootNode,!1,s),a=this.iFrameCW.$("#jsTree").jstree(!0);a.settings.core.data=i,a.refresh()})}}module.exports=TreeRenderer;

},{}],89:[function(require,module,exports){
class Util{constructor(t){this.browser=t}async parseToObject(t){if(this.isString(t)){let e;return e=this.isValidUrl(t)?await this.getJson(t):t,JSON.parse(e)}return t}isString(t){return"string"==typeof t||t instanceof String}isValidUrl(t){try{new URL(t)}catch(t){return!1}return!0}getJson(t){return new Promise(function(e,r){let n=new XMLHttpRequest;n.open("GET",t),n.setRequestHeader("Accept","application/json"),n.onload=function(){this.status>=200&&this.status<300?e(n.response):r({status:this.status,statusText:n.statusText})},n.onerror=function(){r({status:this.status,statusText:n.statusText})},n.send()})}prettyPrintIri(t){return t.replace(/^(schema:|https?:\/\/schema.org\/)(.+)/,"$2")}repairLinksInHTMLCode(t){let e=t;return e=(e=(e=(e=(e=(e=e.replace(/<a(.*?)href="(.*?)"/g,(t,e,r)=>{return r.startsWith("/")&&(r="http://schema.org"+r),"<a"+e+'href="'+r+'" style="'+this.createExternalLinkStyle(r)+'" target="_blank"'})).replace(/\[\[(.*?)]]/g,(t,e)=>{const r="http://schema.org/"+e;return'<a href="'+r+'" style="'+this.createExternalLinkStyle(r)+'" target="_blank">'+e+"</a>"})).replace(/\[(.*?)]\((.*?)\)/g,(t,e,r)=>{return'<a href="'+r+'" style="'+this.createExternalLinkStyle(r)+'" target="_blank">'+e+"</a>"})).replace(/\\n/g,()=>"</br>")).replace(/__(.*?)__/g,(t,e)=>"<b>"+e+"</b>")).replace(/```(.*?)```/g,(t,e)=>"<code>"+e+"</code>")}createInternalLink(t,e){return e=this.escHtml(e),`<a class="a-js-link" href="${this.browser.locationControl?this.createInternalHref(t):"javascript:void(0)"}" ${this.browser.locationControl?'onclick="return false;"':""} ${'data-state-changes="'+encodeURIComponent(JSON.stringify(t))+'"'}>\n        ${e}</a>`}createInternalHref(t,e=!0){let r,n=this.createNavigationState(t),s=window.location.protocol+"//"+(window.location.host?window.location.host:""),a=[];n.listId?(r=s+"/list/"+n.listId,n.dsId&&a.push(["ds",n.dsId])):r=s+"/ds/"+n.dsId,n.path&&a.push(["path",n.path]),n.viewMode&&a.push(["mode",n.viewMode]),n.format&&a.push(["format",n.format]);for(let t=0;t<a.length;t++){let e="&";0===t&&(e="?"),r+=e+a[t][0]+"="+a[t][1]}return e?this.escHtml(r):r}createNavigationState(t){let e={};return void 0!==t.listId?e.listId=t.listId:e.listId=this.browser.listId,void 0!==t.dsId?e.dsId=t.dsId:e.dsId=this.browser.dsId,void 0!==t.path?e.path=t.path:e.path=this.browser.path,void 0!==t.viewMode?e.viewMode=t.viewMode:e.viewMode=this.browser.viewMode,void 0!==t.format?e.format=t.format:e.format=this.browser.format,e}escHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}createHtmlAttr(t){return t?Object.entries(t).map(t=>" "+this.escHtml(t[0])+'="'+this.escHtml(t[1])+'"').join(""):""}createLink(t,e=null,r=null){const n=new URL(t);if(window.location.hostname!==n.hostname||t.includes("/voc/")){let e=" "+this.createExternalLinkStyle(t);r?r.hasOwnProperty("style")?r.style=r.style+e:r.style=e:r={style:e},r.target="_blank"}return'<a href="'+this.escHtml(t)+'"'+this.createHtmlAttr(r)+">"+(e?this.prettyPrintIri(e):this.prettyPrintIri(t))+"</a>"}createExternalLinkStyle(t){let e="background-position: center right; \n            background-repeat: no-repeat;\n            background-size: 10px 10px; \n            padding-right: 13px; ";return/^https?:\/\/schema.org/.test(t)?e+="background-image: url(https://raw.githubusercontent.com/semantifyit/ds-browser/main/images/external-link-icon-red.png);":e+="background-image: url(https://raw.githubusercontent.com/semantifyit/ds-browser/main/images/external-link-icon-blue.png);",e}createHtmlLoading(){return'<div class="text-center" style="margin-top: 100px;"><div class="spinner-border text-danger" style="width: 4rem; height: 4rem;" role="status">\n              <span class="visually-hidden">Loading...</span>\n            </div></div>'}createHtmlTableRow(t,e,r,n,s,a=null){return`<tr typeof="${t}" resource="${e}">\n            ${this.createMainCol(r,n,a)+s}\n            </tr>`}createMainCol(t,e,r=null){return"<th"+(r?' class="'+r+'"':"")+' scope="row">'+this.createCodeLink(e,{property:t})+"</th>"}createCodeLink(t,e=null){return"<code"+this.createHtmlAttr(e)+">"+t+"</code>"}createHtmlDefinitionTable(t,e,r=null,n=null){Array.isArray(t)||(t=[t]),Array.isArray(e)||(e=[e]);const s=this.createHtmlAttr(r),a=this.createHtmlAttr(n);return`<table class="definition-table table" ${s}>\n            <thead><tr>${t.map(t=>"<th>"+t+"</th>").join("")}</tr></thead>\n            <tbody ${a}>\n            ${e[0].startsWith("<tr")?e.join(""):e.map(t=>"<tr>"+t+"</tr>").join("")}\n            </tbody></table>`}createHtmlMainContent(t,e){return`\n            <div>\n                <div id="mainContent" vocab="http://schema.org/" typeof="${t}" resource="${window.location}">\n                    ${e}\n                </div>\n            </div>`}createHtmlExternalLinkLegend(){return'<p style="font-size: 12px; margin-top: 0">(<span style="'+("margin-right: 3px; "+this.createExternalLinkStyle(""))+'"></span>External link<span style="'+("margin-right: 3px; "+this.createExternalLinkStyle("http://schema.org")+" margin-left: 6px;")+'"></span>External link to schema.org )</p>'}createTermLink(t){const e=this.browser.sdoAdapter.getTerm(t),r=e.getVocabURLs();let n;if(r)for(const e of r)if(/http(s)?:\/\/.*?\/voc\//.test(e)){n=e+"?term="+t;break}return n=n||e.getIRI(),this.createLink(n,e.getIRI(!0))}prettyPrintClassDefinition(t){return Array.isArray(t)?t.map(t=>this.prettyPrintIri(t)).join(", "):this.prettyPrintIri(t)}fade(t){let e=.05;const r=setInterval(()=>{e>=1&&clearInterval(r),t.style.opacity=e,t.style.filter="alpha(opacity="+100*e+")",e+=.05*e},10)}getSdoAdapterFromCache(t){for(const e of this.browser.sdoCache){let r=!0;for(const n of t)if(!e.vocabUrls.includes(n)){r=!1;break}for(const n of e.vocabUrls)if(!t.includes(n)){r=!1;break}if(r)return e.sdoAdapter}return null}hardCopyJson(t){return JSON.parse(JSON.stringify(t))}getFileHost(){return this.browser.selfFileHost?window.location.origin:"https://semantify.it"}getLanguageString(t,e="en"){if(Array.isArray(t)){if(0===t.length)return null;let r=t.find(t=>t["@language"]===e);return r||(r=t[0]),r["@value"]}return t}getDSRootNode(t){if(t&&Array.isArray(t["@graph"])){const e=t["@graph"].find(t=>"ds:DomainSpecification"===t["@type"]);if(e)return e}return null}getReferencedNode(t){return this.browser.ds&&Array.isArray(this.browser.ds["@graph"])&&this.browser.ds["@graph"].find(e=>e["@id"]===t)||null}getClassNodeIfExists(t){return t["sh:node"]&&t["sh:node"]["@id"]&&1===Object.keys(t["sh:node"]).length?this.getReferencedNode(t["sh:node"]["@id"]):t["sh:node"]&&t["sh:node"]["sh:class"]?t["sh:node"]:void 0}}module.exports=Util;
