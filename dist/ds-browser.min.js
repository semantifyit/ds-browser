...
"use strict";class DSHandler{constructor(t){this.browser=t,this.util=t.util}getDSNodeForPath(){var t=this.browser.dsRootNode,e={type:"",node:{}};if(t)if(this.browser.path){for(var r=this.browser.path.split("-"),s=0;s<r.length;s++)if(""!==r[s]){var a=void 0;(a=r[s].indexOf(":")>=0?r[s].substring(r[s].indexOf(":")+1):r[s]).charAt(0).toUpperCase()===a.charAt(0)?t&&(t=this.getClass(t["sh:or"],r[s])):t&&s!==r.length-1&&(t=this.getProperty(t["sh:property"],r[s]))}try{this.browser.sdoAdapter.getTerm(t["sh:class"][0]),"schema:Enumeration"===this.browser.sdoAdapter.getTerm(t["sh:class"][0]).getTermType()?e.type="Enumeration":e.type="Class"}catch(t){e.type="error"}}else e.type="Class";else e.type="error";return e.node=t,e}getClass(t,e){for(var r of t)if(r["sh:node"]){var s=this.util.getClassNodeIfExists(r);if(s["sh:class"]&&this.rangesToString(s["sh:class"])===e)return s}return null}getProperty(t,e){return t.find(t=>this.rangesToString(t["sh:path"])===e)}dataTypeMapperFromSHACL(t){switch(t){case"xsd:string":case"rdf:HTML":case"rdf:langString":return"https://schema.org/Text";case"xsd:boolean":return"https://schema.org/Boolean";case"xsd:date":return"https://schema.org/Date";case"xsd:dateTime":return"https://schema.org/DateTime";case"xsd:time":return"https://schema.org/Time";case"xsd:double":return"https://schema.org/Number";case"xsd:float":return"https://schema.org/Float";case"xsd:integer":return"https://schema.org/Integer";case"xsd:anyURI":return"https://schema.org/URL"}return null}rangesToString(t){return Array.isArray(t)?t.map(t=>this.util.prettyPrintIri(t)).join(" + "):this.util.prettyPrintIri(t)}createHtmlCardinality(t,e){var r,s="";return t&&0!==t?e&&0!==e?t!==e?(r="This property is required. It must have between "+t+" and "+e+" value(s).",s=t+".."+e):(r="This property is required. It must have "+t+" value(s).",s=t):(r="This property is required. It must have at least "+t+" value(s).",s=t+"..N"):e&&0!==e?(r="This property is optional. It must have at most "+e+" value(s).",s="0.."+e):(r="This property is optional. It may have any amount of values.",s="0..N"),'<span title="'.concat(r,'">').concat(s,"</span>")}generateDsClass(t,e,r){var s,a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:0,i={},n=t["sh:targetClass"]||t["sh:class"];i.text=n?this.util.prettyPrintClassDefinition(n):"",i.icon="glyphicon glyphicon-list-alt",e||(i.state={opened:!0});try{s=-1===i.text.indexOf(",")?this.util.repairLinksInHTMLCode(this.browser.sdoAdapter.getClass(i.text).getDescription()):"No description found."}catch(t){s="No description found."}return i.data={},i.data.dsDescription=s,i.children=this.processChildren(t,r,a+1),i}processChildren(t,e,r){var s=[],a=t["sh:property"];return a&&a.forEach(t=>{var a=this.generateDsProperty(t,e,r);a&&s.push(a)}),s}generateDsProperty(t,e,r){var s={};return s.justification=this.util.getLanguageString(t["rdfs:comment"]),s.text=this.util.prettyPrintIri(t["sh:path"]),s.data={},s.data.minCount=t["sh:minCount"],s.data.maxCount=t["sh:maxCount"],s.children=[],this.processEnum(s,t["sh:or"][0]),this.processVisibility(s,t["sh:minCount"]),this.processRanges(s,t["sh:or"],e,r),e?s:s.data.isOptional?null:s}processEnum(t,e){var r;t.isEnum=!1;try{var s=e["sh:class"];r=this.browser.sdoAdapter.getEnumeration(s),t.isEnum=!0}catch(t){}if(t.isEnum){var a=this.getEnumMemberArray(e["sh:in"],r);a.forEach(t=>{var e=this.browser.sdoAdapter.getEnumerationMember(t.name);t.description=this.util.repairLinksInHTMLCode(e.getDescription())}),t.data.enuMembers=a,t.children=a.map(t=>({children:[],data:{dsRange:"",dsDescription:this.util.repairLinksInHTMLCode(t.description)},icon:"glyphicon glyphicon-chevron-right",text:t.name}))}}getEnumMemberArray(t,e){return t?t.map(t=>{var e=t["@id"];return{name:e=e.replace("schema:","")}}):e.getEnumerationMembers().map(t=>({name:t}))}processVisibility(t,e){t.icon="glyphicon glyphicon-tag",!e>0?(t.icon+=" optional-property",t.data.isOptional=!0):(t.icon+=" mandatory-property",t.data.isOptional=!1)}processRanges(t,e,r,s){var a=!1;if(e){var i=this.generateDsRange(e);t.data.dsRange=i.rangeAsString;try{var n=this.browser.sdoAdapter.getProperty(t.text).getDescription();t.data.dsDescription=this.util.repairLinksInHTMLCode(n)}catch(e){t.data.dsDescription="No description found."}e.forEach(e=>{var i=this.util.getClassNodeIfExists(e);i&&i["sh:class"]&&(a=!0,s<8&&t.children.push(this.generateDsClass(i,!0,r,s)))})}a&&(t.state={opened:!0})}generateDsRange(t){var e={rangeAsString:""};return e.rangeAsString=t.map(t=>{var e,r,s=t["sh:datatype"],a=this.util.getClassNodeIfExists(t),i=a&&a["sh:class"]?a["sh:class"]:null;return s?(e=this.util.prettyPrintIri(this.dataTypeMapperFromSHACL(s)),r="rdf:langString"===s?"Localized Text":"rdf:HTML"===s?"HTML Text":e):r=a&&a["sh:property"]?"<strong>"+(e=this.util.prettyPrintClassDefinition(i))+"</strong>":e=this.util.prettyPrintClassDefinition(i),r}).join(" or "),e}}module.exports=DSHandler;

},{}],82:[function(require,module,exports){
"use strict";function _defineProperty(e,t,i){return t in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}class DSRenderer{constructor(e){_defineProperty(this,"MODES",{native:"native",tree:"tree",table:"table"}),this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler}createViewModeSelectors(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:this.MODES.native;return'<div class="ds-selector-tabs ds-selector"><div class="selectors">'+(e===this.MODES.native?'<a class="selected">Native View</a>':this.util.createInternalLink({viewMode:null},"Native View"))+(e===this.MODES.tree?'<a class="selected">Tree View</a>':this.util.createInternalLink({viewMode:"tree"},"Tree View"))+(e===this.MODES.table?'<a class="selected">Table View</a>':this.util.createInternalLink({viewMode:"table"},"Table View"))+"</div></div>"}createHtmlHeader(){this.dsNode=this.browser.dsNode,this.node=this.dsNode.node;var e,t,i="";if(this.browser.path){var r=this.node["sh:class"];e=this.dsHandler.rangesToString(r),t=this.createNodeDescription(r),i=this.createBreadcrumbs()}else{var a=this.browser.ds["@graph"][0];e=this.util.getLanguageString(a["schema:name"])||"Domain Specification",t=this.util.getLanguageString(a["schema:description"])||""}return t=this.util.repairLinksInHTMLCode(t),this.createNavigation()+'<h1 property="schema:name">'+e+"</h1>"+this.util.createHtmlExternalLinkLegend()+i+'<div property="schema:description">'+t+"<br><br></div>"}createNodeDescription(e){return e?1===e.length?this.browser.sdoAdapter.getTerm(e[0]).getDescription():e.map(e=>"<b>"+this.util.prettyPrintIri(e)+":</b> "+this.browser.sdoAdapter.getTerm(e).getDescription()).join("<br>"):""}createBreadcrumbs(){var e=this.util.createInternalLink({path:null},this.util.getLanguageString(this.browser.dsRootNode["schema:name"])||"Domain Specification"),t=this.browser.path.split("-").map((e,t,i)=>{if(t%2==0)return e;var r=i.slice(0,t+1).join("-");return this.util.createInternalLink({path:r},e)}).join(" > ");return'<h4><span class="breadcrumbs">\n            '.concat(e," > ").concat(t,"\n            </span></h4>")}createNavigation(){var e,t=this.browser.dsId;e=this.browser.locationControl?this.util.createInternalLink({format:"shacl"},"SHACL serialization"):'<a href="https://semantify.it/ds/'.concat(t,'?format=shacl" target="_blank">SHACL serialization</a>');var i=this.browser.list?" | from List: "+this.util.createInternalLink({dsId:null,path:null},this.browser.list["schema:name"]):"";return'<span style="float: right;">('.concat(e).concat(i,")</span>")}createVisBtnRow(){return'<div id="btn-row" style="padding: 12px 0px 12px 5px; font-size: 14px; line-height: 1.42857143; color: #333;">Show: \n            <span id="btn-opt" class="btn-vis btn-vis-shadow" style="margin-left: 10px; padding: 5px;">\n                <img src="" class="glyphicon glyphicon-tag optional-property"> optional\n            </span>\n            <span id="btn-man" class="btn-vis" style="margin-left: 10px; padding: 5px;">\n                <img src="" class="glyphicon glyphicon-tag mandatory-property"> mandatory\n            </span></div>'}}module.exports=DSRenderer;
...
"use strict";class NativeRenderer{constructor(e){this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler,this.dsRenderer=e.dsRenderer}render(){this.dsNode=this.browser.dsNode,this.node=this.dsNode.node;var e=this.dsRenderer.createHtmlHeader()+this.dsRenderer.createViewModeSelectors(this.dsRenderer.MODES.native)+("Class"===this.dsNode.type?this.createHtmlPropertiesTable():this.createHTMLEnumerationMembersTable());this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdfs:Class",e)}createHTMLEnumerationMembersTable(){var e=this.node["sh:in"].slice(0).map(e=>this.createHTMLEnumerationMemberRow(e)).join("");return this.util.createHtmlDefinitionTable(["Enumeration Member","Description"],e,{style:"margin-top: 0px; border-top: none;"})}createHTMLEnumerationMemberRow(e){var t=this.browser.sdoAdapter.getEnumerationMember(e["@id"]);return this.util.createHtmlTableRow("rdfs:Class",t.getIRI(),"rdfs:label",this.util.createTermLink(e["@id"]),this.createHTMLEnumerationMemberDescription(t))}createHTMLEnumerationMemberDescription(e){var t=this.util.repairLinksInHTMLCode(e.getDescription());return'<td className="prop-desc">'.concat(t,"</td>")}createHtmlPropertiesTable(){var e=this.node["sh:property"].slice(0).map(e=>this.createClassProperty(e)).join("");return this.util.createHtmlDefinitionTable(["Property","Expected Type","Description","Cardinality"],e,{style:"margin-top: 0px; border-top: none;"})}createClassProperty(e){var t=e["sh:path"],r=this.browser.sdoAdapter.getProperty(t);return this.util.createHtmlTableRow("rdf:Property",r.getIRI(),"rdfs:label",this.util.createTermLink(t),this.createClassPropertySideCols(e),"prop-name")}createClassPropertySideCols(e){var t=this.createHtmlExpectedTypes(e),r=this.createHtmlPropertyDescription(e),s=this.dsHandler.createHtmlCardinality(e["sh:minCount"],e["sh:maxCount"]);return'<td class="prop-ect">'.concat(t,'</td>\n            <td class="prop-desc">').concat(r,'</td>\n            <td class="prop-ect" style="text-align: center">').concat(s,"</td>")}createHtmlPropertyDescription(e){var t,r=this.util.prettyPrintIri(e["sh:path"]);try{t=this.browser.sdoAdapter.getProperty(r).getDescription()}catch(e){t=""}var s=e["rdfs:comment"]?this.util.getLanguageString(e["rdfs:comment"]):"",i="";return""!==t&&(""!==s&&(i+="<b>From Vocabulary:</b> "),i+=t),""!==s&&(""!==t&&(i+="<br><b>From Domain Specification:</b> "),i+=s),this.util.repairLinksInHTMLCode(i)}createHtmlExpectedTypes(e){var t=this.browser.sdoAdapter.getProperty(e["sh:path"]),r=this.util.prettyPrintIri(t.getIRI(!0));return e["sh:or"].map(e=>{var t,s=this.util.getClassNodeIfExists(e);e["sh:datatype"]?t=e["sh:datatype"]:s&&s["sh:class"]&&(t=s["sh:class"]);var i=this.dsHandler.dataTypeMapperFromSHACL(t);if(null!==i){var a=null;return"rdf:langString"===t?a="Localized Text":"rdf:HTML"===t&&(a="HTML Text"),this.util.createLink(i,a)}if(t=this.dsHandler.rangesToString(t),s&&Array.isArray(s["sh:property"])&&0!==s["sh:property"].length){var n=this.browser.path?this.browser.path+"-"+r+"-"+t:r+"-"+t;return this.util.createInternalLink({path:n},t)}if(s&&s["sh:class"]&&Array.isArray(s["sh:in"])){var o=this.browser.path?this.browser.path+"-"+r+"-"+t:r+"-"+t;return this.util.createInternalLink({path:o},t)}return this.util.createTermLink(t)}).join("<br>")}}module.exports=NativeRenderer;
