...
"use strict";var _schemaOrgAdapter=_interopRequireDefault(require("schema-org-adapter")),_Util=_interopRequireDefault(require("./Util")),_DSHandler=_interopRequireDefault(require("./DSHandler")),_ListRenderer=_interopRequireDefault(require("./ListRenderer")),_DSRenderer=_interopRequireDefault(require("./DSRenderer"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,r,t,n,i,s,a){try{var o=e[s](a),d=o.value}catch(e){return void t(e)}o.done?r(d):Promise.resolve(d).then(n,i)}function _asyncToGenerator(e){return function(){var r=this,t=arguments;return new Promise(function(n,i){var s=e.apply(r,t);function a(e){asyncGeneratorStep(s,n,i,a,o,"next",e)}function o(e){asyncGeneratorStep(s,n,i,a,o,"throw",e)}a(void 0)})}}var BROWSER_TYPES={DS:"DS",LIST:"LIST"};class DSBrowser{constructor(e,r){var t=this,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:BROWSER_TYPES.DS;this.elem=e,this.dsOrList=r,this.type=n,this.path=null,this.util=new _Util.default(this),this.dsHandler=new _DSHandler.default(this),this.dsRenderer=new _DSRenderer.default(this),this.listRenderer=new _ListRenderer.default(this),window.addEventListener("popstate",_asyncToGenerator(function*(){yield t.render()}))}render(){var e=this;return _asyncToGenerator(function*(){e.elem.innerHTML='<img src="https://raw.githubusercontent.com/YarnSeemannsgarn/ds-browser/main/images/loading.gif" alt="Loading Animation" style="margin-top: 6px">',yield e.init(),e.isDSRendering()?e.dsRenderer.render():e.isListRendering()&&e.listRenderer.render(),e.addJSLinkEventListener(),document.body.scrollTop=document.documentElement.scrollTop=0})()}init(){var e=this;return _asyncToGenerator(function*(){e.listNeedsInit()&&(yield e.initList()),e.dsNeedsInit()?(yield e.initDS(),e.initDSNode()):e.dsNodeNeedsInit()&&e.initDSNode()})()}listNeedsInit(){return this.type===BROWSER_TYPES.LIST&&!this.list}initList(){var e=this;return _asyncToGenerator(function*(){e.list=yield e.util.parseToObject(e.dsOrList)})()}dsNeedsInit(){var e=new URLSearchParams(window.location.search).get("ds");return this.type===BROWSER_TYPES.LIST&&e&&e!==this.dsUID||this.type===BROWSER_TYPES.DS&&!this.ds}initDS(){var e=this;return _asyncToGenerator(function*(){if(e.type===BROWSER_TYPES.DS)e.ds=yield e.util.parseToObject(e.dsOrList);else if(e.type===BROWSER_TYPES.LIST){var r=new URLSearchParams(window.location.search);for(var t of(e.dsUID=r.get("ds"),e.list["schema:hasPart"])){var n=t["@id"];if(n.split("/").pop()===e.dsUID){e.ds=yield e.util.parseToObject(n);break}}}e.sdoAdapter=new _schemaOrgAdapter.default;var i=yield e.getVocabUrlsForDS();yield e.sdoAdapter.addVocabularies(i)})()}getVocabUrlsForDS(){var e=this;return _asyncToGenerator(function*(){var r=[];if(e.ds&&e.ds["@graph"][0]&&Array.isArray(e.ds["@graph"][0]["ds:usedVocabularies"])&&(r=e.ds["@graph"][0]["ds:usedVocabularies"]),e.ds&&e.ds["@graph"][0]&&e.ds["@graph"][0]["schema:schemaVersion"]){var t=e.getSDOVersion();r.push(yield e.sdoAdapter.constructSDOVocabularyURL(t))}return r})()}getSDOVersion(){return/.*schema\.org\/version\/([0-9\.]+)\//g.exec(this.ds["@graph"][0]["schema:schemaVersion"])[1]}initDSNode(){var e=new URLSearchParams(window.location.search);this.path=e.get("path"),this.dsNode=this.dsHandler.getDSNodeForPath()}dsNodeNeedsInit(){return new URLSearchParams(window.location.search).get("path")!==this.path}isDSRendering(){var e=new URLSearchParams(window.location.search);return this.type===BROWSER_TYPES.LIST&&e.get("ds")||this.type===BROWSER_TYPES.DS}isListRendering(){var e=new URLSearchParams(window.location.search);return this.type===BROWSER_TYPES.LIST&&!e.get("voc")}addJSLinkEventListener(){var e=this,r=this.elem.getElementsByClassName("a-js-link"),t=function(r){r.addEventListener("click",function(){var t=_asyncToGenerator(function*(t){t.ctrlKey?window.open(r.href):(history.pushState(null,null,r.href),yield e.render())});return function(e){return t.apply(this,arguments)}}())};for(var n of r)t(n)}}module.exports=DSBrowser;

},{"./DSHandler":85,"./DSRenderer":86,"./ListRenderer":87,"./Util":88,"schema-org-adapter":78}],85:[function(require,module,exports){
"use strict";class DSHandler{constructor(s){this.browser=s,this.util=s.util}getDSNodeForPath(){var s=this.browser.ds["@graph"][0],r={type:"",node:{}};if(this.browser.ds)if(this.browser.path){for(var t=this.browser.path.split("-"),e=0;e<t.length;e++)""!==t[e]&&(t[e].charAt(0).toUpperCase()===t[e].charAt(0)?null!==s&&(s=this.getClass(s["sh:or"],t[e])):null!==s&&e!==t.length-1&&(s=void 0!==s["sh:targetClass"]?this.getProperty(s["sh:property"],t[e]):this.getProperty(s["sh:node"]["sh:property"],t[e])));if(s&&s["sh:class"]&&!Array.isArray(s["sh:class"]))try{this.browser.sdoAdapter.getEnumeration(s["sh:class"]),r.type="Enumeration"}catch(s){r.type="Class"}else r.type="Class"}else r.type="Class";else r.type="error";return r.node=s,r}getClass(s,r){for(var t=0;t<s.length;t++)if(void 0!==s[t]["sh:class"]&&this.util.rangesToString(s[t]["sh:class"])===r)return s[t];return null}getProperty(s,r){for(var t=0;t<s.length;t++)if(this.util.rangesToString(s[t]["sh:path"])===r)return s[t];return null}}module.exports=DSHandler;

},{}],86:[function(require,module,exports){
"use strict";class DSRenderer{constructor(e){this.browser=e,this.util=e.util}render(){this.dsNode=this.browser.dsNode,this.node=this.dsNode.node;var e=this.createHeader()+("Class"===this.dsNode.type?this.createClassPropertyTable():this.createEnumerationMembers());this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",e)}createHeader(){var e,t;if(this.browser.path){var r=this.node["sh:class"];e=this.util.prettyPrintIri(r),t=this.browser.sdoAdapter.getTerm(r).getDescription()}else{var s=this.browser.ds["@graph"][0];e=s["schema:name"],t=s["schema:description"]}return'<h1 property="schema:name">'+e+'</h1><div property="schema:description">'+(t=this.util.repairLinksInHTMLCode(t))+"<br><br></div>"}createClassPropertyTable(){return'<table class="definition-table"><thead><tr><th>Property</th><th>Expected Type</th><th>Description</th><th>Cardinality</th></tr></thead><tbody>'+(this.browser.path?this.node["sh:node"]["sh:property"].slice(0):this.node["sh:property"].slice(0)).map(e=>this.createClassProperty(e)).join("")+"</tbody></table>"}createClassProperty(e){var t=this.browser.sdoAdapter.getProperty(e["sh:path"]),r=this.util.prettyPrintIri(t.getIRI(!0)),s=this.createExpectedTypes(r,e["sh:or"]),a=this.createCardinality(e);return'<tr><th class="prop-nam" scope="row"><code property="rdfs:label">'+this.util.repairLinksInHTMLCode('<a href="'+t.getIRI()+'">'+r+"</a>")+'</code></th><td class="prop-ect">'+s+'</td><td class="prop-desc">'+this.createClassPropertyDescText(e)+'</td><td class="prop-ect">'+a+"</td></tr>"}createClassPropertyDescText(e){var t=this.util.prettyPrintIri(e["sh:path"]),r="";try{r=this.browser.sdoAdapter.getProperty(t).getDescription()}catch(e){}var s=e["rdfs:comment"]?e["rdfs:comment"]:"",a="";return""!==r&&(""!==s&&(a+="<b>From Vocabulary:</b> "),a+=r),""!==s&&(""!==r&&(a+="<br><b>From Domain Specification:</b> "),a+=s),this.util.repairLinksInHTMLCode(a)}createExpectedTypes(e,t){var r="";return t.forEach(t=>{var s;if(t["sh:datatype"]?s=t["sh:datatype"]:t["sh:class"]&&(s=t["sh:class"]),null!==this.util.dataTypeMapperFromSHACL(s))r+=this.util.repairLinksInHTMLCode('<a href="/'+this.util.dataTypeMapperFromSHACL(s)+'">'+this.util.dataTypeMapperFromSHACL(s)+"</a>");else{s=this.util.rangesToString(s);var a=e+"-"+s;r+=this.util.createJSLink("path",a,"-",s)}r+="<br>"}),r}createCardinality(e){var t,r=e["sh:minCount"],s=e["sh:maxCount"],a="";return r&&0!==r?s&&0!==s?r!==s?(t="This property is required. It must have between "+r+" and "+s+" value(s).",a=r+".."+s):(t="This property is required. It must have "+r+" value(s).",a=r):(t="This property is required. It must have at least "+r+" value(s).",a=r+"..N"):s&&0!==s?(t="This property is optional. It must have at most "+s+" value(s).",a="0.."+s):(t="This property is optional. It may have any amount of values.",a="0..N"),'<span title="'+t+'">'+a+"</span>"}createEnumerationMembers(){var e=this.browser.sdoAdapter.getTerm(this.node["sh:class"]).getEnumerationMembers();return 0!==e.length?'An Enumeration with:<br><b><a id="enumbers" title="Link: #enumbers" href="#enumbers" class="clickableAnchor">Enumeration members</a></b><ul>'+e.map(e=>{var t=this.browser.sdoAdapter.getEnumerationMember(e);return"<li>"+this.util.repairLinksInHTMLCode('<a href="'+t.getIRI()+'">'+this.util.prettyPrintIri(e)+"</a>")+"</li>"}).join("")+"</ul><br>":""}}module.exports=DSRenderer;

},{}],87:[function(require,module,exports){
"use strict";class ListRenderer{constructor(e){this.browser=e,this.util=e.util}render(){var e=this.createHeader()+this.createDSTable();this.browser.elem.innerHTML=this.util.createMainContent("schema:DataSet",e)}createHeader(){return"<h1>"+this.browser.list["schema:name"]+"</h1>"}createDSTable(){return this.util.createDefinitionTable(["Name","IRI","Description"],this.createDSTbody(),{class:"supertype"})}createDSTbody(){return this.browser.list["schema:hasPart"].map(e=>this.util.createTableRow("http://vocab.sti2.at/ds/Domain Specification",e["@id"],"schema:name",this.util.createJSLink("ds",e["@id"].split("/").pop(),null,e["schema:name"]||"No Name"),this.createDSSideCols(e))).join("")}createDSSideCols(e){return'<td property="@id">'+this.util.createExternalLink(e["@id"])+'</td><td property="schema:description">'+(e["schema:description"]||"")+"</td>"}}module.exports=ListRenderer;

},{}],88:[function(require,module,exports){
"use strict";function asyncGeneratorStep(t,e,r,n,a,s,i){try{var o=t[s](i),l=o.value}catch(t){return void r(t)}o.done?e(l):Promise.resolve(l).then(n,a)}function _asyncToGenerator(t){return function(){var e=this,r=arguments;return new Promise(function(n,a){var s=t.apply(e,r);function i(t){asyncGeneratorStep(s,n,a,i,o,"next",t)}function o(t){asyncGeneratorStep(s,n,a,i,o,"throw",t)}i(void 0)})}}class Util{constructor(t){this.browser=t}parseToObject(t){var e=this;return _asyncToGenerator(function*(){var r;return e.isString(t)?(r=e.isValidUrl(t)?yield e.getJson(t):t,JSON.parse(r)):t})()}isString(t){return"string"==typeof t||t instanceof String}isValidUrl(t){try{new URL(t)}catch(t){return!1}return!0}getJson(t){return new Promise(function(e,r){var n=new XMLHttpRequest;n.open("GET",t),n.setRequestHeader("Accept","application/json"),n.onload=function(){this.status>=200&&this.status<300?e(n.response):r({status:this.status,statusText:n.statusText})},n.onerror=function(){r({status:this.status,statusText:n.statusText})},n.send()})}prettyPrintIri(t){return t.startsWith("schema:")?t.substring("schema:".length):this.escHtml(t)}makeURLFromIRI(t){var e=this.browser.sdoAdapter.getVocabularies();return Object.keys(e).forEach(r=>{if(t.startsWith(r))return e[r]+t.substring(t.indexOf(":")+1)}),""}repairLinksInHTMLCode(t){return t.replace(/<a(.*?)href="(.*?)"/g,(t,e,r)=>{r.startsWith("/")&&(r="http://schema.org"+r);var n="background-position: center right; background-repeat: no-repeat; background-size: 10px 10px; padding-right: 13px; ";return/^https?:\/\/schema.org/.test(r)?n+="background-image: url(https://raw.githubusercontent.com/YarnSeemannsgarn/ds-browser/main/images/external-link-icon-red.png);":n+="background-image: url(https://raw.githubusercontent.com/YarnSeemannsgarn/ds-browser/main/images/external-link-icon-blue.png);","<a"+e+'href="'+r+'" style="'+n+'" target="_blank"'})}dataTypeMapperFromSHACL(t){switch(t){case"xsd:string":return"Text";case"xsd:boolean":return"Boolean";case"xsd:date":return"Date";case"xsd:dateTime":return"DateTime";case"xsd:time":return"Time";case"xsd:double":return"Number";case"xsd:float":return"Float";case"xsd:integer":return"Integer";case"xsd:anyURI":return"URL"}return null}rangesToString(t){return Array.isArray(t)?t.map(t=>this.prettyPrintIri(t)).join(" + "):this.prettyPrintIri(t)}createIriWithQueryParam(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=new URLSearchParams(window.location.search);if(e&&""!==e){var a=n.get(t);null!==a&&r?n.set(t,a+r+e):n.set(t,e)}else n.delete(t);var s=n.toString();return window.location.protocol+"//"+(window.location.host?window.location.host:"")+window.location.pathname+(""!==s?"?"+s:"")}createJSLink(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null,s=this.createIriWithQueryParam(t,e,r);return'<a class="a-js-link" href="'+this.escHtml(s)+'" onclick="return false;"'+this.createHtmlAttr(a)+">"+(n?this.escHtml(n):this.escHtml(e))+"</a>"}escHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}createHtmlAttr(t){return t?Object.entries(t).map(t=>" "+this.escHtml(t[0])+'="'+this.escHtml(t[1])+'"').join(""):""}createExternalLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=" "+this.createExternalLinkStyle(t);return r?r.hasOwnProperty("style")?r.style=r.style+n:r.style=n:r={style:n},'<a href="'+this.escHtml(t)+'" target="_blank"'+this.createHtmlAttr(r)+">"+(e?this.prettyPrintIri(e):this.prettyPrintIri(t))+"</a>"}createExternalLinkStyle(t){var e="background-position: center right; background-repeat: no-repeat; background-size: 10px 10px; padding-right: 13px; ";return-1===t.indexOf("https://schema.org")&&-1===t.indexOf("http://schema.org")?e+="background-image: url(https://raw.githubusercontent.com/YarnSeemannsgarn/ds-browser/main/images/external-link-icon-blue.png);":e+="background-image: url(https://raw.githubusercontent.com/YarnSeemannsgarn/ds-browser/main/images/external-link-icon-red.png);",e}createTableRow(t,e,r,n,a){var s=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null;return'<tr typeof="'+t+'" resource="'+e+'">'+this.createMainCol(r,n,s)+a+"</tr>"}createMainCol(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return"<th"+(r?' class="'+r+'"':"")+' scope="row">'+this.createCodeLink(e,{property:t})+"</th>"}createCodeLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;return"<code"+this.createHtmlAttr(e)+">"+this.createFullLink(t,r,n)+"</code>"}createFullLink(t,e,r){var n=null;try{n=this.browser.sdoAdapter.getTerm(t)}catch(t){}return""+(r?this.createSemanticLink(r,t):"")+(n?this.createLink(t,e):t)}createSemanticLink(t,e){return'<link property="'+this.escHtml(t)+'" href="'+this.escHtml(this.createHref(e))+'">'}createHref(t){return this.browser.sdoAdapter.getTerm(t).getIRI()}createLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.createExternalLink(this.createHref(t),t,e)}createDefinitionTable(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return Array.isArray(t)||(t=[t]),Array.isArray(e)||(e=[e]),'<table class="definition-table"><thead><tr>'+t.map(t=>"<th>"+t+"</th>").join("")+"</tr></thead><tbody"+this.createHtmlAttr(r)+">"+(e[0].startsWith("<tr")?e.join(""):e.map(t=>"<tr>"+t+"</tr>").join(""))+"</tbody></table>"}createMainContent(t,e){return'<div id="mainContent" vocab="http://schema.org/" typeof="'+t+'" resource="'+window.location+'">'+e+"</div>"}}module.exports=Util;
