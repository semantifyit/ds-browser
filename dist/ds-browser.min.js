...
"use strict";class NativeRenderer{constructor(e){this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler,this.dsRenderer=e.dsRenderer}render(){this.dsNode=this.browser.dsNode,this.node=this.dsNode.node;var e=this.dsRenderer.createHtmlHeader()+this.dsRenderer.createViewModeSelectors(this.dsRenderer.MODES.native)+("Class"===this.dsNode.type?this.createHtmlPropertiesTable():this.createHTMLEnumerationMembersTable());this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdfs:Class",e)}createHTMLEnumerationMembersTable(){var e=this.node["sh:in"].slice(0).map(e=>this.createHTMLEnumerationMemberRow(e)).join("");return this.util.createHtmlDefinitionTable(["Enumeration Member","Description"],e,{style:"margin-top: 0px; border-top: none;"})}createHTMLEnumerationMemberRow(e){var t=this.browser.sdoAdapter.getEnumerationMember(e["@id"]);return this.util.createHtmlTableRow("rdfs:Class",t.getIRI(),"rdfs:label",this.util.createTermLink(e["@id"]),this.createHTMLEnumerationMemberDescription(t))}createHTMLEnumerationMemberDescription(e){var t=this.util.repairLinksInHTMLCode(e.getDescription());return'<td className="prop-desc">'.concat(t,"</td>")}createHtmlPropertiesTable(){var e=(this.browser.path?this.node["sh:node"]["sh:property"].slice(0):this.node["sh:property"].slice(0)).map(e=>this.createClassProperty(e)).join("");return this.util.createHtmlDefinitionTable(["Property","Expected Type","Description","Cardinality"],e,{style:"margin-top: 0px; border-top: none;"})}createClassProperty(e){var t=e["sh:path"],r=this.browser.sdoAdapter.getProperty(t);return this.util.createHtmlTableRow("rdf:Property",r.getIRI(),"rdfs:label",this.util.createTermLink(t),this.createClassPropertySideCols(e),"prop-name")}createClassPropertySideCols(e){var t=this.createHtmlExpectedTypes(e),r=this.createHtmlPropertyDescription(e),s=this.dsHandler.createHtmlCardinality(e["sh:minCount"],e["sh:maxCount"]);return'<td class="prop-ect">'.concat(t,'</td>\n            <td class="prop-desc">').concat(r,'</td>\n            <td class="prop-ect" style="text-align: center">').concat(s,"</td>")}createHtmlPropertyDescription(e){var t,r=this.util.prettyPrintIri(e["sh:path"]);try{t=this.browser.sdoAdapter.getProperty(r).getDescription()}catch(e){t=""}var s=e["rdfs:comment"]?e["rdfs:comment"]:"",i="";return""!==t&&(""!==s&&(i+="<b>From Vocabulary:</b> "),i+=t),""!==s&&(""!==t&&(i+="<br><b>From Domain Specification:</b> "),i+=s),this.util.repairLinksInHTMLCode(i)}createHtmlExpectedTypes(e){var t=this.browser.sdoAdapter.getProperty(e["sh:path"]),r=this.util.prettyPrintIri(t.getIRI(!0));return e["sh:or"].map(e=>{var t;e["sh:datatype"]?t=e["sh:datatype"]:e["sh:class"]&&(t=e["sh:class"]);var s=this.dsHandler.dataTypeMapperFromSHACL(t);if(null!==s)return this.util.createLink(s);if(t=this.dsHandler.rangesToString(t),e["sh:node"]&&Array.isArray(e["sh:node"]["sh:property"])&&0!==e["sh:node"]["sh:property"].length){var i=this.browser.path?this.browser.path+"-"+r+"-"+t:r+"-"+t;return this.util.createInternalLink({path:i},t)}if(e["sh:class"]&&Array.isArray(e["sh:in"])){var a=this.browser.path?this.browser.path+"-"+r+"-"+t:r+"-"+t;return this.util.createInternalLink({path:a},t)}return this.util.createTermLink(t)}).join("<br>")}}module.exports=NativeRenderer;
