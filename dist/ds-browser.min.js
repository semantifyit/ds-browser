...
"use strict";class NativeRenderer{constructor(e){this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler,this.dsRenderer=e.dsRenderer}render(){this.dsNode=this.browser.dsNode,this.node=this.dsNode.node;var e=this.dsRenderer.createHtmlHeader()+this.dsRenderer.createViewModeSelectors(this.dsRenderer.MODES.native)+("Class"===this.dsNode.type?this.createHtmlPropertiesTable():this.createEnumerationMembers());this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdfs:Class",e)}createHtmlPropertiesTable(){var e=(this.browser.path?this.node["sh:node"]["sh:property"].slice(0):this.node["sh:property"].slice(0)).map(e=>this.createClassProperty(e)).join("");return this.util.createHtmlDefinitionTable(["Property","Expected Type","Description","Cardinality"],e,{style:"margin-top: 0px; border-top: none;"})}createClassProperty(e){var r=e["sh:path"],t=this.browser.sdoAdapter.getProperty(r);return this.util.createHtmlTableRow("rdf:Property",t.getIRI(),"rdfs:label",this.util.createTermLink(r),this.createClassPropertySideCols(e),"prop-name")}createClassPropertySideCols(e){var r=this.createHtmlExpectedTypes(e),t=this.createHtmlPropertyDescription(e),s=this.dsHandler.createHtmlCardinality(e["sh:minCount"],e["sh:minCount"]);return'<td class="prop-ect">'.concat(r,'</td>\n            <td class="prop-desc">').concat(t,'</td>\n            <td class="prop-ect">').concat(s,"</td>")}createHtmlPropertyDescription(e){var r,t=this.util.prettyPrintIri(e["sh:path"]);try{r=this.browser.sdoAdapter.getProperty(t).getDescription()}catch(e){r=""}var s=e["rdfs:comment"]?e["rdfs:comment"]:"",i="";return""!==r&&(""!==s&&(i+="<b>From Vocabulary:</b> "),i+=r),""!==s&&(""!==r&&(i+="<br><b>From Domain Specification:</b> "),i+=s),this.util.repairLinksInHTMLCode(i)}createHtmlExpectedTypes(e){var r=this.browser.sdoAdapter.getProperty(e["sh:path"]),t=this.util.prettyPrintIri(r.getIRI(!0));return e["sh:or"].map(e=>{var r;e["sh:datatype"]?r=e["sh:datatype"]:e["sh:class"]&&(r=e["sh:class"]);var s=this.dsHandler.dataTypeMapperFromSHACL(r);if(null!==s)return this.util.createLink(s);if(r=this.dsHandler.rangesToString(r),e["sh:node"]&&Array.isArray(e["sh:node"]["sh:property"])&&0!==e["sh:node"]["sh:property"].length){var i=this.browser.path?this.browser.path+"-"+t+"-"+r:t+"-"+r;return this.util.createInternalLink({path:i},r)}if(e["sh:class"]&&Array.isArray(e["sh:in"])){var a=this.browser.path?this.browser.path+"-"+t+"-"+r:t+"-"+r;return this.util.createInternalLink({path:a},r)}return this.util.createTermLink(r)}).join("<br>")}createEnumerationMembers(){var e=this.browser.sdoAdapter.getTerm(this.node["sh:class"]).getEnumerationMembers();if(0!==e.length){var r=e.map(e=>{var r=this.browser.sdoAdapter.getEnumerationMember(e);return"<li>"+this.util.createLink(r.getIRI(),e)+"</li>"}).join("");return'An Enumeration with:<br>\n                <b><a id="enumbers" title="Link: #enumbers" href="#enumbers" class="clickableAnchor">Enumeration members</a></b>\n                <ul>'.concat(r,"</ul><br>")}return""}}module.exports=NativeRenderer;
