...
"use strict";class DSHandler{constructor(t){this.browser=t,this.util=t.util}getDSNodeForPath(){var t=this.browser.dsRootNode,e={type:"",node:{}};if(t)if(this.browser.path){for(var r=this.browser.path.split("-"),s=0;s<r.length;s++)if(""!==r[s]){var a=void 0;(a=r[s].indexOf(":")>=0?r[s].substring(r[s].indexOf(":")+1):r[s]).charAt(0).toUpperCase()===a.charAt(0)?t&&(t=this.getClass(t["sh:or"],r[s])):t&&s!==r.length-1&&(t=this.getProperty(t["sh:property"],r[s]))}try{this.browser.sdoAdapter.getTerm(t["sh:class"][0]),"schema:Enumeration"===this.browser.sdoAdapter.getTerm(t["sh:class"][0]).getTermType()?e.type="Enumeration":e.type="Class"}catch(t){e.type="error"}}else e.type="Class";else e.type="error";return e.node=t,e}getClass(t,e){return t.find(t=>t["sh:node"]&&t["sh:node"]["sh:class"]&&this.rangesToString(t["sh:node"]["sh:class"])===e)["sh:node"]}getProperty(t,e){return t.find(t=>this.rangesToString(t["sh:path"])===e)}dataTypeMapperFromSHACL(t){switch(t){case"xsd:string":case"rdf:langString":return"https://schema.org/Text";case"xsd:boolean":return"https://schema.org/Boolean";case"xsd:date":return"https://schema.org/Date";case"xsd:dateTime":return"https://schema.org/DateTime";case"xsd:time":return"https://schema.org/Time";case"xsd:double":return"https://schema.org/Number";case"xsd:float":return"https://schema.org/Float";case"xsd:integer":return"https://schema.org/Integer";case"xsd:anyURI":return"https://schema.org/URL"}return null}rangesToString(t){return Array.isArray(t)?t.map(t=>this.util.prettyPrintIri(t)).join(" + "):this.util.prettyPrintIri(t)}createHtmlCardinality(t,e){var r,s="";return t&&0!==t?e&&0!==e?t!==e?(r="This property is required. It must have between "+t+" and "+e+" value(s).",s=t+".."+e):(r="This property is required. It must have "+t+" value(s).",s=t):(r="This property is required. It must have at least "+t+" value(s).",s=t+"..N"):e&&0!==e?(r="This property is optional. It must have at most "+e+" value(s).",s="0.."+e):(r="This property is optional. It may have any amount of values.",s="0..N"),'<span title="'.concat(r,'">').concat(s,"</span>")}generateDsClass(t,e,r){var s,a={},i=t["sh:targetClass"]||t["sh:class"];a.text=i?this.util.prettyPrintClassDefinition(i):"",a.icon="glyphicon glyphicon-list-alt",e||(a.state={opened:!0});try{s=-1===a.text.indexOf(",")?this.util.repairLinksInHTMLCode(this.browser.sdoAdapter.getClass(a.text).getDescription()):"No description found."}catch(t){s="No description found."}return a.data={},a.data.dsDescription=s,a.children=this.processChildren(t,r),a}processChildren(t,e){var r=[],s=t["sh:property"];return s&&s.forEach(t=>{var s=this.generateDsProperty(t,e);s&&r.push(s)}),r}generateDsProperty(t,e){var r={};return r.justification=this.util.getLanguageString(t["rdfs:comment"]),r.text=this.util.prettyPrintIri(t["sh:path"]),r.data={},r.data.minCount=t["sh:minCount"],r.data.maxCount=t["sh:maxCount"],r.children=[],this.processEnum(r,t["sh:or"][0]),this.processVisibility(r,t["sh:minCount"]),this.processRanges(r,t["sh:or"],e),e?r:r.data.isOptional?null:r}processEnum(t,e){var r;t.isEnum=!1;try{var s=e["sh:class"];r=this.browser.sdoAdapter.getEnumeration(s),t.isEnum=!0}catch(t){}if(t.isEnum){var a=this.getEnumMemberArray(e["sh:in"],r);a.forEach(t=>{var e=this.browser.sdoAdapter.getEnumerationMember(t.name);t.description=this.util.repairLinksInHTMLCode(e.getDescription())}),t.data.enuMembers=a,t.children=a.map(t=>({children:[],data:{dsRange:"",dsDescription:this.util.repairLinksInHTMLCode(t.description)},icon:"glyphicon glyphicon-chevron-right",text:t.name}))}}getEnumMemberArray(t,e){return t?t.map(t=>{var e=t["@id"];return{name:e=e.replace("schema:","")}}):e.getEnumerationMembers().map(t=>({name:t}))}processVisibility(t,e){t.icon="glyphicon glyphicon-tag",!e>0?(t.icon+=" optional-property",t.data.isOptional=!0):(t.icon+=" mandatory-property",t.data.isOptional=!1)}processRanges(t,e,r){var s=!1;if(e){var a=this.generateDsRange(e);t.data.dsRange=a.rangeAsString;try{var i=this.browser.sdoAdapter.getProperty(t.text).getDescription();t.data.dsDescription=this.util.repairLinksInHTMLCode(i)}catch(e){t.data.dsDescription="No description found."}e.forEach(e=>{if(e["sh:node"]&&e["sh:node"]["sh:class"]){s=!0;var a=this.generateDsClass(e["sh:node"],!0,r);t.children.push(a)}})}s&&(t.state={opened:!0})}generateDsRange(t){var e={rangeAsString:""};return e.rangeAsString=t.map(t=>{var e=t["sh:datatype"],r=t["sh:node"]&&t["sh:node"]["sh:class"]?t["sh:node"]["sh:class"]:null;return e?this.util.prettyPrintIri(this.dataTypeMapperFromSHACL(e)):t["sh:node"]&&t["sh:node"]["sh:property"]?"<strong>"+this.util.prettyPrintClassDefinition(r)+"</strong>":this.util.prettyPrintClassDefinition(r)}).join(" or "),e}}module.exports=DSHandler;
...
"use strict";function asyncGeneratorStep(t,e,r,a,n,i,s){try{var o=t[i](s),l=o.value}catch(t){return void r(t)}o.done?e(l):Promise.resolve(l).then(a,n)}function _asyncToGenerator(t){return function(){var e=this,r=arguments;return new Promise(function(a,n){var i=t.apply(e,r);function s(t){asyncGeneratorStep(i,a,n,s,o,"next",t)}function o(t){asyncGeneratorStep(i,a,n,s,o,"throw",t)}s(void 0)})}}class Util{constructor(t){this.browser=t}parseToObject(t){var e=this;return _asyncToGenerator(function*(){var r;return e.isString(t)?(r=e.isValidUrl(t)?yield e.getJson(t):t,JSON.parse(r)):t})()}isString(t){return"string"==typeof t||t instanceof String}isValidUrl(t){try{new URL(t)}catch(t){return!1}return!0}getJson(t){return new Promise(function(e,r){var a=new XMLHttpRequest;a.open("GET",t),a.setRequestHeader("Accept","application/json"),a.onload=function(){this.status>=200&&this.status<300?e(a.response):r({status:this.status,statusText:a.statusText})},a.onerror=function(){r({status:this.status,statusText:a.statusText})},a.send()})}prettyPrintIri(t){return t.replace(/^(schema:|https?:\/\/schema.org\/)(.+)/,"$2")}repairLinksInHTMLCode(t){var e=t;return e=(e=(e=(e=(e=(e=e.replace(/<a(.*?)href="(.*?)"/g,(t,e,r)=>{return r.startsWith("/")&&(r="http://schema.org"+r),"<a"+e+'href="'+r+'" style="'+this.createExternalLinkStyle(r)+'" target="_blank"'})).replace(/\[\[(.*?)]]/g,(t,e)=>{var r="http://schema.org/"+e;return'<a href="'+r+'" style="'+this.createExternalLinkStyle(r)+'" target="_blank">'+e+"</a>"})).replace(/\[(.*?)]\((.*?)\)/g,(t,e,r)=>{return'<a href="'+r+'" style="'+this.createExternalLinkStyle(r)+'" target="_blank">'+e+"</a>"})).replace(/\\n/g,(t,e,r)=>"</br>")).replace(/__(.*?)__/g,(t,e,r)=>"<b>"+e+"</b>")).replace(/```(.*?)```/g,(t,e)=>"<code>"+e+"</code>")}createInternalLink(t,e){e=this.escHtml(e);var r=this.browser.locationControl?this.createInternalHref(t):"javascript:void(0)",a=this.browser.locationControl?'onclick="return false;"':"",n='data-state-changes="'+encodeURIComponent(JSON.stringify(t))+'"';return'<a class="a-js-link" href="'.concat(r,'" ').concat(a," ").concat(n,">\n        ").concat(e,"</a>")}createInternalHref(t){var e,r=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],a=this.createNavigationState(t),n=window.location.protocol+"//"+(window.location.host?window.location.host:""),i=[];a.listId?(e=n+"/list/"+a.listId,a.dsId&&i.push(["ds",a.dsId])):e=n+"/ds/"+a.dsId,a.path&&i.push(["path",a.path]),a.viewMode&&i.push(["mode",a.viewMode]),a.format&&i.push(["format",a.format]);for(var s=0;s<i.length;s++){var o="&";0===s&&(o="?"),e+=o+i[s][0]+"="+i[s][1]}return r?this.escHtml(e):e}createNavigationState(t){var e={};return void 0!==t.listId?e.listId=t.listId:e.listId=this.browser.listId,void 0!==t.dsId?e.dsId=t.dsId:e.dsId=this.browser.dsId,void 0!==t.path?e.path=t.path:e.path=this.browser.path,void 0!==t.viewMode?e.viewMode=t.viewMode:e.viewMode=this.browser.viewMode,void 0!==t.format?e.format=t.format:e.format=this.browser.format,e}escHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}createHtmlAttr(t){return t?Object.entries(t).map(t=>" "+this.escHtml(t[0])+'="'+this.escHtml(t[1])+'"').join(""):""}createLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,a=new URL(t);if(window.location.hostname!==a.hostname||t.includes("/voc/")){var n=" "+this.createExternalLinkStyle(t);r?r.hasOwnProperty("style")?r.style=r.style+n:r.style=n:r={style:n},r.target="_blank"}return'<a href="'+this.escHtml(t)+'"'+this.createHtmlAttr(r)+">"+(e?this.prettyPrintIri(e):this.prettyPrintIri(t))+"</a>"}createExternalLinkStyle(t){var e="background-position: center right; \n            background-repeat: no-repeat;\n            background-size: 10px 10px; \n            padding-right: 13px; ";return/^https?:\/\/schema.org/.test(t)?e+="background-image: url(https://raw.githubusercontent.com/semantifyit/ds-browser/main/images/external-link-icon-red.png);":e+="background-image: url(https://raw.githubusercontent.com/semantifyit/ds-browser/main/images/external-link-icon-blue.png);",e}createHtmlLoading(){return'<div style="text-align: center">\n            <img src="https://raw.githubusercontent.com/semantifyit/ds-browser/main/images/loading.gif"\n             alt="Loading Animation" style="margin-top: 100px;">\n            </div>'}createHtmlTableRow(t,e,r,a,n){var i=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null,s=this.createMainCol(r,a,i)+n;return'<tr typeof="'.concat(t,'" resource="').concat(e,'">\n            ').concat(s,"\n            </tr>")}createMainCol(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return"<th"+(r?' class="'+r+'"':"")+' scope="row">'+this.createCodeLink(e,{property:t})+"</th>"}createCodeLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return"<code"+this.createHtmlAttr(e)+">"+t+"</code>"}createHtmlDefinitionTable(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;Array.isArray(t)||(t=[t]),Array.isArray(e)||(e=[e]);var n=this.createHtmlAttr(r),i=this.createHtmlAttr(a),s=t.map(t=>"<th>"+t+"</th>").join(""),o=e[0].startsWith("<tr")?e.join(""):e.map(t=>"<tr>"+t+"</tr>").join("");return'<table class="definition-table table" '.concat(n,">\n            <thead><tr>").concat(s,"</tr></thead>\n            <tbody ").concat(i,">\n            ").concat(o,"\n            </tbody></table>")}createHtmlMainContent(t,e){return'\n            <div>\n                <div id="mainContent" vocab="http://schema.org/" typeof="'.concat(t,'" resource="').concat(window.location,'">\n                    ').concat(e,"\n                </div>\n            </div>")}createHtmlExternalLinkLegend(){return'<p style="font-size: 12px; margin-top: 0">(<span style="'+("margin-right: 3px; "+this.createExternalLinkStyle(""))+'"></span>External link<span style="'+("margin-right: 3px; "+this.createExternalLinkStyle("http://schema.org")+" margin-left: 6px;")+'"></span>External link to schema.org )</p>'}createTermLink(t){var e,r=this.browser.sdoAdapter.getTerm(t),a=r.getVocabURLs();if(a)for(var n of a)if(/http(s)?:\/\/.*?\/voc\//.test(n)){e=n+"?term="+t;break}return e=e||r.getIRI(),this.createLink(e,r.getIRI(!0))}prettyPrintClassDefinition(t){return Array.isArray(t)?t.map(t=>this.prettyPrintIri(t)).join(", "):this.prettyPrintIri(t)}fade(t){var e=.05,r=setInterval(()=>{e>=1&&clearInterval(r),t.style.opacity=e,t.style.filter="alpha(opacity="+100*e+")",e+=.05*e},10)}getSdoAdapterFromCache(t){for(var e of this.browser.sdoCache){var r=!0;for(var a of t)if(!e.vocabUrls.includes(a)){r=!1;break}for(var n of e.vocabUrls)if(!t.includes(n)){r=!1;break}if(r)return e.sdoAdapter}return null}hardCopyJson(t){return JSON.parse(JSON.stringify(t))}getFileHost(){return this.browser.selfFileHost?window.location.origin:"https://semantify.it"}getLanguageString(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"en";if(Array.isArray(t)){if(0===t.length)return null;var r=t.find(t=>t["@language"]===e);return r||(r=t[0]),r["@value"]}return t}getDSRootNode(t){if(t&&Array.isArray(t["@graph"])){var e=t["@graph"].find(t=>"ds:DomainSpecification"===t["@type"]);if(e)return e}return null}}module.exports=Util;
